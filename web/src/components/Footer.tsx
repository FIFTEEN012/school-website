            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-gray-400">
                  โรงเรียนประชารัฐพัฒนศึกษา เลขที่ 100 หมู่ 5 ต.หมูม่น อ.สมเด็จ จ.กาฬสินธุ์ 46150
                </span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:prsforwork2024@gmail.com" className="text-sm text-gray-400 hover:text-primary-400 transition-colors">
                  prsforwork2024@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-3">
